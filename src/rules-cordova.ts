import { checkCordovaAndroidPreference, checkCordovaAndroidPreferenceMinimum, checkCordovaIosPreference, checkMinVersion, exists, isGreaterOrEqual, warnMinVersion } from "./analyzer";
